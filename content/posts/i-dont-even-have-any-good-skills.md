...
This is a collection of skills I have been evolving for on my own project. I typically use my Claude Pro subscription in a terminal on my Framework and, to preserve tokens, assign grunt tasks to [qwen3-coder:30b](https://ollama.com/library/qwen3-coder:30b) running on an RTX 4090 on a gaming machine I bought from Scorptec two years ago. 
